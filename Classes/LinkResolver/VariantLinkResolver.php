 ...
 *
 * @package Portrino\PxShopware\LinkResolver
 */
class VariantLinkResolver extends AbstractLinkResolver
{

    /**
     * VariantLinkResolver constructor.
     */
    public function __construct()
    {
        $objectManager = GeneralUtility::makeInstance(ObjectManager::class);
        $this->client = $objectManager->get(VariantClientInterface::class);
    }
}
