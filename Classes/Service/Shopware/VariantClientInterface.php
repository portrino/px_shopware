...
/**
 * Interface VariantClientInterface
 *
 * @package Portrino\PxShopware\Service\Shopware
 */
interface VariantClientInterface extends AbstractShopwareApiClientInterface
{

    const ENDPOINT = 'variants';
    const CACHE_TAG = 'shopware_variant';
    const ENTITY_CLASS_NAME = Variant::class;
